...
残念ながら、現在のAdobe Reader（バージョン8.Xから10.1.1まで）では、縮小
版の作成に少々問題があります。
...
んが）、作成される縮小版画像には全体が正方形になるように左右または上下
には余白が追加されてしまいます。Alissa's PDF Thumbnail Trimmerは、この
余白を取り除きます。（これがTrimmerという名前の由来です。）

(2) 64ビット版のWindows（x64エディションとも言います）を使っている場合
には、PDFファイルを作成したりコピーしたりした後すぐにPDFの縮小版がフォ
ルダー画面に現れないことがあります。（まったく現れる様子が見えないかも
しれません。）Alissa's PDF Thumbnail Trimmerは、64ビット版のWindowsでも、
PDFの縮小版を確実に表示します。
...
Readerのバージョン9または10をインストールしておく必要があります。Adobe
Readerのバージョン8でも動作するかもしれません。（ただし、Adobe Reader
のバージョン8にはさまざまな問題があると言われているので、利用は勧められ
ません。）Adobe Acrobat でも利用できるかもしれません。
...
含まれませんが、インストーラーと同じ場所でダウンロードできるはずです。
これを書いている時点では、ソースファイルと最新のバイナリの配布元は以下
の SkyDrive のページです。
